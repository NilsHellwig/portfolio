    ...
    <div className="">
      ...
      <div className="mt-6 grid vsm:grid-cols-2 gap-6">
        {languages.map((language, index) => (
          <div key={index}>
            <div className="bg-white w-16 h-16 p-3 rounded-2xl border-gray-200 border">{language.iconPath && <img src={language.iconPath} alt={`${language.name} icon`} className="mr-2" />}</div>
