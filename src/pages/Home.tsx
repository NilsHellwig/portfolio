...
const Home: React.FC = () => {
  return (
    <motion.div
      className="mt-20 flex justify-center flex-col items-center"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
    ...
    >
      ...
      />
      <motion.h2
        className="mt-6 text-4xl font-bold dark:text-white"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      <motion.h3
        className="font-light text-zinc-700 dark:text-zinc-300 text-xl text-center mb-6"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        transition={{ duration: 0.5, delay: 1.5 }}
      >
        I am an AI researcher at University of Regensburg, where I work on Structured Sentiment
