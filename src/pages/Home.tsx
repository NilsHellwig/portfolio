...
const Home: React.FC = () => {
  return (
    <div className="mt-20 flex justify-center flex-col items-center">
      ...
      <h3 className="font-light text-zinc-500 text-xl">Software Development. Data Science.</h3>
      <Link to="/portfolio/about">
        <div className="bg-black px-4 py-2 rounded-xl flex gap-2 mt-6 cursor-pointer hover:bg-zinc-700 duration-300">
