  ...
  return (
    <div className="flex flex-row items-center mt-2 mb-4 justify-center flex-col gap-2 xsm:justify-between xsm:flex-row xsm:gap-0">
      ...
      <div className="flex flex-row gap-3">
        <motion.div className="p-1 hover:bg-zinc-200 rounded-lg cursor-pointer duration-300" onClick={() => openLinkInNewTab("https://twitter.com/nchllwg")} whileHover="hover" variants={iconVariants}>
